...
export const ProfileResumeHeadlineSection = (props: any) => {
    ...
    const sectionId = 'resume-headline';
        ...
        <div
            ...
            <div className={classNames("left-sec", { [isEditable]: 'left-sec-edit' })}>
                ...
                </h5>
                {
                    data ?
                        <p>{data}</p>
                        : <Typography className={'helperText'} variant='body2'>A resume is a summary which quickly communicates and grabs the attention of the hiring manager.</Typography>
                }
            </div>
            {
                isEditable ?
